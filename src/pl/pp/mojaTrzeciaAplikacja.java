...
public class mojaTrzeciaAplikacja {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            var liczbaDni = scanner.nextInt();
            if(liczbaDni > 0){
                System.out.println("Liczba tygodni: " + liczbaDni / 7);
                System.out.println("Liczba dni: " + liczbaDni % 7);
            }
            if(liczbaDni<=0){
                System.out.println("Zła ilość dni");
            }
            System.out.println("Jeśli chcesz zamknąć program wpisz liczbe mniejszą niż 0 ");
            var wyjsc = scanner.nextInt();
            if(wyjsc < 0 ) {
                System.out.println("Wyjście");
                break;
            }
        ...
        while(true) {
            ...
            var faren = scanner.nextDouble();
            if (faren > -459) {
                if(true) {
                    double celcju;
                    double kelwin;
                    celcju = (faren - 32) / 1.8;
                    kelwin = celcju + 273.16;
                    System.out.println("Stopnie Fahrenheit'a: " + faren);
